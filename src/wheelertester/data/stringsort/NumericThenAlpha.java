...
/**
 * A basic stringsorter that places numeric characters before alphabetic ones
 */
public class NumericThenAlpha extends wheeler.generic.data.stringsort.StringSorter{
    
    public NumericThenAlpha(){
        super(false, false);
    }
    ...
    private final String precedence = "0123456789abcdefghijklmnopqrstuvwxyz";
